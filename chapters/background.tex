...
\begin{figure}[h]
	...
	\includegraphics[width=0.9\linewidth]{images/visual_slam_steps.pdf}    
...
\begin{figure}[h]
    \centering
    \includegraphics[page=2, width=0.6\linewidth]{images/search_tese.pdf}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.6\linewidth]{images/SA.pdf}
