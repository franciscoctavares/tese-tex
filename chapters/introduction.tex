...
\begin{itemize}
    ...
    \item Development of an automatic \ac{HPT} framework within \ac{RUSTLE} to better optimize and compare the performance of multiple \ac{SLAM} solutions.
    
    \item Assessment of the impact(importance) different hyperparameters have on several SLAM methods.
