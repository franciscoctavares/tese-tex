...
\begin{figure}[h]
    ...
    \caption[Fast-LIVO2 system overview.]{Fast-LIVO2 system overview~\cite{fastlivo2_article1}.}
...
\begin{figure}[h]
    ...
    \caption[A bird view of the 3D survey map of BotanicGarden.]{A bird view of the 3D survey map of BotanicGarden~\cite{liu2024botanicgarden}.}
