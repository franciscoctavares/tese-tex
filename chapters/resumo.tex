...
desenvolvimento deste trabalho. Os algoritmos desenvolvidos foram testados em duas soluções de \ac{SLAM}. Os resultados mostram o potencial do \textit{Simulated Annealing} em relação aos restantes algoritmos implementados, conseguindo em certos casos reduzir o erro da trajetória em mais de metade. Por último, são apresentadas sugestões para melhorias futuras.
